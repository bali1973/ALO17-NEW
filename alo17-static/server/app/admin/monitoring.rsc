...
d:["$","$1","c",{"children":[["$","div",null,{"className":"min-h-screen bg-gray-50","children":["$","div",null,{"className":"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8","children":[["$","div",null,{"className":"mb-8","children":[["$","h1",null,{"className":"text-3xl font-bold text-gray-900","children":"Sistem İzleme Paneli"}],["$","p",null,{"className":"mt-2 text-gray-600","children":"Sistem performansı, hatalar ve kullanıcı aktivitelerini takip edin"}]]}],["$","$L16",null,{"timeRange":"24h","refreshInterval":30000}]]}]}],null,["$","$L17",null,{"children":["$L18",["$","$L19",null,{"promise":"$@1a"}]]}]]}]
