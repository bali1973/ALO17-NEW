...
import { FaTv, FaDesktop, FaProjectDiagram } from 'react-icons/fa'
import { useState } from 'react'
import { listings } from '@/lib/listings'
import { ListingCard } from '@/components/listing-card'

const subcategories = [
  { id: 'smart-tv', name: 'Smart TV', icon: <FaTv className="inline mr-2 text-purple-500" /> },
  { id: 'monitor', name: 'Monitör', icon: <FaDesktop className="inline mr-2 text-purple-500" /> },
  { id: 'projeksiyon', name: 'Projeksiyon', icon: <FaProjectDiagram className="inline mr-2 text-purple-500" /> },
]
...
export default function TelevizyonCategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Televizyon</h1>
        <p className="text-gray-600 mt-2">
          Smart TV'ler, monitörler ve projeksiyon cihazları
        </p>
      </div>
