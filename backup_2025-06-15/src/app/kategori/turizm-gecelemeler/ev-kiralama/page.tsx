...
export default function HouseRentalCategoryPage() {
  const [selectedType, setSelectedType] = useState<string | null>(null)
  const [priceRange, setPriceRange] = useState<string | null>(null)
  const [location, setLocation] = useState<string | null>(null)
  const [features, setFeatures] = useState<string[]>([])

  // Ev kiralama ilanlarını filtrele
  const houseListings = listings.filter(listing => 
    listing.category === 'turizm-gecelemeler' && 
    listing.subcategory === 'ev-kiralama'
  )

  // Ev tiplerini topla
  const types = Array.from(new Set(houseListings.map(listing => listing.type)))
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Ev Kiralama</h1>
        <p className="text-gray-600 mt-2">
          Yazlık evler, villalar, dağ evleri ve köy evleri kiralama seçenekleri.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            {/* Ev Tipi Filtresi */}
            <div className="mb-6">
              <h3 className="font-medium mb-2">Ev Tipi</h3>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                {['İstanbul', 'Antalya', 'Muğla', 'Aydın', 'İzmir', 'Bodrum', 'Çeşme', 'Fethiye'].map(city => (
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">
                {filteredListings.length} ev bulundu
              </span>
              <select 
          ...
          {filteredListings.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Seçtiğiniz kriterlere uygun ev bulunamadı. Lütfen filtreleri değiştirerek tekrar deneyin.
              </p>
            </div>
          )}
        </div>
