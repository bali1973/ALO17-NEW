...
export default function CameraCategoryPage() {
  ...
  // Markaları topla
  const brands = Array.from(new Set(cameraListings.map(listing => listing.brand)))
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Kamera ve Fotoğraf Makineleri</h1>
        <p className="text-gray-600 mt-2">
          Profesyonel ve amatör kamera modellerini inceleyebilirsiniz.
        </p>
      </div>
