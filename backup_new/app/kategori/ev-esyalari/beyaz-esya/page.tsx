...
export default function WhiteGoodsCategoryPage() {
  ...
  const whiteGoodsListings = listings.filter(listing => 
    listing.category === 'ev-esyalari' && 
    listing.subcategory === 'beyaz-esya'
  )

  // Markaları topla
  const brands = Array.from(new Set(whiteGoodsListings.map(listing => listing.brand)))

  // Filtreleme fonksiyonu
  const filteredListings = whiteGoodsListings.filter(listing => {
