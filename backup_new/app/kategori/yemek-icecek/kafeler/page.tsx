...
export default function CafesCategoryPage() {
  ...
  const cafeListings = listings.filter(listing => 
    listing.category === 'yemek-icecek' && 
    listing.subcategory === 'kafeler'
  )

  // Kafe türlerini topla
  const cafeTypes = Array.from(new Set(cafeListings.map(listing => listing.brand)))

  // Filtreleme fonksiyonu
  const filteredListings = cafeListings.filter(listing => {
