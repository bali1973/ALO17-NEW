...
export default function MuzikKurslariPage() {
    ...
    fetch('/api/listings')
      ...
      .then(data => {
        setListings(data.filter((listing: Listing) => 
          listing.category === 'egitim-kurslar' && listing.subCategory === 'muzik-kurslari'
        ));
      });
  }, []);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Müzik Kursları</h1>
