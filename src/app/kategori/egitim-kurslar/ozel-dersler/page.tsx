...
export default function OzelDerslerPage() {
    ...
    fetch('/api/listings')
      ...
      .then(data => {
        setListings(data.filter((listing: Listing) => 
          listing.category === 'egitim-kurslar' && listing.subCategory === 'ozel-dersler'
        ));
      });
  }, []);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Özel Dersler</h1>
