...
export default function EgitimKurslarPage() {
  ...
  return (
    <CategoryLayout
      ...
      activeSlug=""
      categoryBasePath="kategori/egitim-kurslar"
      city={city}
    ...
    >
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Eğitim & Kurslar</h1>
        <p className="text-gray-600 mt-2">
          Dil kursları, müzik dersleri ve eğitim hizmetleri
        </p>
      </div>
