...
const subcategories = [
  ...
  { id: 'ios', name: 'iOS Tablet', icon: <FaTabletAlt className="inline mr-2 text-blue-500" /> },
  { id: 'windows', name: 'Windows Tablet', icon: <FaTabletAlt className="inline mr-2 text-blue-500" /> },
]
...
export default function TabletCategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Tablet</h1>
        <p className="text-gray-600 mt-2">
          Android, iOS ve Windows tabletler
        </p>
      </div>
