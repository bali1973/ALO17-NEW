...
export default function ElektrikliEvAletleriPage() {
    ...
    fetch('/api/listings')
      ...
      .then(data => {
        setListings(data.filter((listing: Listing) => 
          listing.category === 'ev-bahce' && listing.subCategory === 'elektrikli-ev-aletleri'
        ));
      });
  }, []);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Elektrikli Ev Aletleri</h1>
