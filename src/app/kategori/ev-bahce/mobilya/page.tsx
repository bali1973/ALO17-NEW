...
const subcategories = [
  { id: 'koltuk', name: 'Koltuk', icon: <FaCouch className="inline mr-2 text-brown-500" /> },
  { id: 'masa', name: 'Masa', icon: <FaChair className="inline mr-2 text-brown-500" /> },
  { id: 'yatak', name: 'Yatak', icon: <FaBed className="inline mr-2 text-brown-500" /> },
]
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Koltuk, masa, yatak ve diğer mobilya ürünleri
        </p>
      </div>
