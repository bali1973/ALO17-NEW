...
export default function GiyimPage() {
  ...
  const mainCategory = categories.find(cat => cat.slug === 'giyim');
  ...
  return (
    <CategoryLayout
      ...
      activeSlug=""
      categoryBasePath="kategori/giyim"
      city={city}
    ...
    >
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Giyim</h1>
        <p className="text-gray-600 mt-2">
          Erkek, kadın ve çocuk giyim ürünleri
        </p>
      </div>
