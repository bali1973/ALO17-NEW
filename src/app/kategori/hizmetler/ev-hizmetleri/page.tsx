...
import { FaHome, FaBroom, FaWrench, FaPaintBrush, FaLeaf, FaShieldAlt, FaClock, FaMoneyBillWave, FaMapMarkerAlt, FaStar, FaCheckCircle } from 'react-icons/fa'
import { useState } from 'react'
import { Sparkles, Star, Clock, TrendingUp } from 'lucide-react'

// Ev hizmetleri ilanları
const evHizmetleri = [
  {
    id: 1,
    title: 'Profesyonel Ev Temizliği',
    provider: 'Temizlik Uzmanı',
    location: 'İstanbul',
    price: '150 - 300',
    type: 'Temizlik',
    duration: '2-4 saat',
    description: 'Profesyonel ev temizliği hizmeti. Detaylı temizlik, cam temizliği, ütü dahil.',
    ...
    isUrgent: true,
    isFeatured: true,
    services: ['Genel temizlik', 'Cam temizliği', 'Ütü', 'Banyo temizliği'],
    benefits: ['Profesyonel ekipman', 'Sigortalı hizmet', 'Memnuniyet garantisi'],
    experience: '5 yıl'
  },
  {
    id: 2,
    ...
    type: 'Tamirat',
    duration: '1-3 saat',
    description: 'Elektrik arızaları, priz tamiri, aydınlatma sistemleri kurulumu ve bakımı.',
    ...
    isUrgent: false,
    isFeatured: false,
    services: ['Elektrik arıza', 'Priz tamiri', 'Aydınlatma', 'Sigorta değişimi'],
    benefits: ['7/24 hizmet', 'Garantili işçilik', 'Fiyat garantisi'],
    experience: '8 yıl'
  },
  {
    id: 3,
    title: 'Ev Boya Badana',
    provider: 'Boya Ustası',
    location: 'İzmir',
    price: '800 - 2.000',
    type: 'Boya',
    duration: '1-3 gün',
    description: 'İç mekan boya badana işleri. Tavan, duvar boyama, dekoratif boya uygulamaları.',
    ...
    isUrgent: false,
    isFeatured: true,
    services: ['İç mekan boya', 'Tavan boyama', 'Dekoratif boya', 'Hazırlık işleri'],
    benefits: ['Kaliteli boya', 'Temiz işçilik', '1 yıl garanti'],
    experience: '12 yıl'
  },
  {
    id: 4,
    title: 'Bahçe Bakım Hizmeti',
    provider: 'Bahçıvan',
    location: 'Bursa',
    price: '300 - 800',
    type: 'Bahçe',
    duration: '2-6 saat',
    description: 'Bahçe bakımı, çim biçme, ağaç budama, çiçek dikimi ve sulama sistemleri.',
    ...
    isUrgent: true,
    isFeatured: false,
    services: ['Çim biçme', 'Ağaç budama', 'Çiçek dikimi', 'Sulama sistemi'],
    benefits: ['Profesyonel ekipman', 'Düzenli bakım', 'Yeşil alan garantisi'],
    experience: '6 yıl'
  },
  {
    id: 5,
    ...
    type: 'Tesisat',
    duration: '1-4 saat',
    description: 'Su kaçağı, tıkanıklık, musluk tamiri, su tesisatı kurulumu ve bakımı.',
    ...
    isUrgent: false,
    isFeatured: false,
    services: ['Su kaçağı', 'Tıkanıklık açma', 'Musluk tamiri', 'Tesisat kurulumu'],
    benefits: ['Acil müdahale', 'Garantili işçilik', 'Parça garantisi'],
    experience: '10 yıl'
  },
  {
    id: 6,
    title: 'Mobilya Montaj Hizmeti',
    provider: 'Mobilya Ustası',
    location: 'Çanakkale',
    price: '150 - 400',
    type: 'Montaj',
    duration: '2-5 saat',
    description: 'Mobilya montajı, demontaj, taşıma ve yerleştirme hizmetleri.',
    ...
    isUrgent: true,
    isFeatured: true,
    services: ['Mobilya montajı', 'Demontaj', 'Taşıma', 'Yerleştirme'],
    benefits: ['Profesyonel montaj', 'Zarar garantisi', 'Hızlı hizmet'],
    experience: '7 yıl'
  }
]

export default function EvHizmetleriPage() {
  ...
  const filteredHizmetler = evHizmetleri
    .filter(hizmet => {
  ...
  const serviceTypes = ['Temizlik', 'Tamirat', 'Boya', 'Bahçe', 'Tesisat', 'Montaj']
  ...
  const getServiceIcon = (type: string) => {
    switch (type) {
      case 'Temizlik':
        return <FaBroom className="w-4 h-4 text-blue-500" />
      case 'Tamirat':
        return <FaWrench className="w-4 h-4 text-red-500" />
      case 'Boya':
        return <FaPaintBrush className="w-4 h-4 text-green-500" />
      case 'Bahçe':
        return <FaLeaf className="w-4 h-4 text-green-600" />
      case 'Tesisat':
        return <FaShieldAlt className="w-4 h-4 text-blue-600" />
      case 'Montaj':
        return <FaHome className="w-4 h-4 text-purple-500" />
      default:
        return <FaHome className="w-4 h-4 text-gray-500" />
    }
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Ev Hizmetleri</h1>
        <p className="text-gray-600 mt-2">
          Ev temizliği, tamirat, boya, bahçe bakımı ve daha fazlası. Eviniz için profesyonel hizmetler.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            {/* Ev Hizmetleri Avantajları */}
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="font-medium text-blue-800 mb-2">Ev Hizmetleri Avantajları</h3>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Profesyonel hizmet</li>
                <li>• Garantili işçilik</li>
                <li>• Esnek saatler</li>
                <li>• Güvenilir ustalar</li>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">
                {filteredHizmetler.length} ev hizmeti bulundu
                {showPremiumOnly && (
          ...
          {filteredHizmetler.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Seçtiğiniz kriterlere uygun ev hizmeti bulunamadı. Lütfen filtreleri değiştirerek tekrar deneyin.
              </p>
              <button
                onClick={() => {
