...
// Örnek hizmet ilanları
const serviceListings = [
  {
    id: 1,
    title: 'Profesyonel Ev Temizlik Hizmeti',
    price: '150',
    location: 'Çanakkale',
    ...
    isUrgent: true,
    isFeatured: true,
    description: 'Güvenilir ve deneyimli temizlik personeli ile ev temizlik hizmeti'
  },
  {
    id: 2,
    ...
    isUrgent: false,
    isFeatured: false,
    description: 'İlkokul, ortaokul ve lise öğrencileri için matematik dersi'
  },
  {
    id: 3,
    ...
    isUrgent: false,
    isFeatured: true,
    description: 'Modern ve responsive web sitesi tasarımı ve geliştirme'
  },
  {
    id: 4,
    title: 'Araç Bakım ve Onarım',
    price: '300',
    location: 'Çanakkale',
    image: '/images/placeholder.jpg',
    category: 'hizmetler',
    subcategory: 'arac-hizmetleri',
    condition: 'Hizmet',
    ...
    isUrgent: true,
    isFeatured: false,
    description: 'Profesyonel araç bakım ve onarım hizmeti'
  },
  {
    id: 5,
    ...
    isUrgent: false,
    isFeatured: false,
    description: 'Logo, kartvizit, broşür ve diğer grafik tasarım işleri'
  },
  {
    id: 6,
    ...
    isUrgent: true,
    isFeatured: true,
    description: 'Deneyimli avukat ile hukuki danışmanlık hizmeti'
  }
]
