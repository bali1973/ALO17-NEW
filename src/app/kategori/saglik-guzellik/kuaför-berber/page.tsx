...
export default function SalonCategoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Kuaför & Berber</h1>
        <p className="text-gray-600 mt-2">
          Saç kesimi, şekillendirme ve bakım hizmetleri.
        </p>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">
                {filteredListings.length} salon bulundu
              </span>
              <select 
          ...
          {filteredListings.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Seçtiğiniz kriterlere uygun salon bulunamadı. Lütfen filtreleri değiştirerek tekrar deneyin.
              </p>
            </div>
          )}
        </div>
