...
export default function DessertBakeryCategoryPage() {
  ...
  const dessertBakeryListings = listings.filter(listing => 
    listing.category === 'yemek-icecek' && 
    listing.subcategory === 'tatli-pastane'
  )

  // Mekan türlerini topla
  const types = Array.from(new Set(dessertBakeryListings.map(listing => listing.brand)))

  // Filtreleme fonksiyonu
  const filteredListings = dessertBakeryListings.filter(listing => {
