      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <Link href="/" className="text-2xl font-bold text-alo-blue">
              ALO17.TR
            </Link>
            <p className="text-base text-gray-500">
              Türkiye'nin en büyük ilan platformu. Emlak, Vasıta, Elektronik ve daha fazlası için güvenilir alışveriş.
            </p>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.categories.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-base text-gray-500 hover:text-alo-orange"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} ALO17.TR. Tüm hakları saklıdır.
          </p>
        </div>
      </div>
    </footer>
