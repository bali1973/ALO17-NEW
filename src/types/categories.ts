...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      { id: 1104, name: 'Freelance', slug: 'freelance' },
      { id: 1105, name: 'Staj', slug: 'staj' },
      { id: 1106, name: 'Geçici İş', slug: 'gecici-is' },
      { id: 1107, name: 'Yönetici', slug: 'yonetici' },
      { id: 1108, name: 'Uzman', slug: 'uzman' },
      { id: 1109, name: 'Mühendis', slug: 'muhendis' },
      { id: 1110, name: 'Teknisyen', slug: 'teknisyen' },
      { id: 1111, name: 'Operatör', slug: 'operator' },
      { id: 1112, name: 'Satış & Pazarlama', slug: 'satis-pazarlama' },
      { id: 1113, name: 'Muhasebe & Finans', slug: 'muhasebe-finans' },
      { id: 1114, name: 'İnsan Kaynakları', slug: 'insan-kaynaklari' },
      { id: 1115, name: 'Bilgi Teknolojileri', slug: 'bilgi-teknolojileri' },
      { id: 1116, name: 'Müşteri Hizmetleri', slug: 'musteri-hizmetleri' },
      { id: 1117, name: 'Üretim & İmalat', slug: 'uretim-imalat' },
      { id: 1118, name: 'Lojistik & Depo', slug: 'lojistik-depo' },
      { id: 1119, name: 'Eğitim & Öğretim', slug: 'egitim-ogretim' },
      { id: 1120, name: 'Sağlık & Bakım', slug: 'saglik-bakim' },
      { id: 1121, name: 'Diğer', slug: 'diger' },
    ],
  },
  {
    id: 12,
